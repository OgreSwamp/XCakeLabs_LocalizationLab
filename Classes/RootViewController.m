...
- (void)addHelpScreen {
    UIButton *helpView = [[UIButton alloc] initWithFrame:CGRectMake(0, 20, 320, 460)];
    helpView.backgroundColor = [UIColor clearColor];
    UIImage *background = [UIImage imageNamed:@"help_screen"];
    [helpView setImage:background forState:UIControlStateNormal];
    [helpView setImage:background forState:UIControlStateHighlighted];
    [helpView addTarget:helpView action:@selector(removeFromSuperview) forControlEvents:UIControlEventTouchUpInside];
    [self.parentViewController.view addSubview:helpView];
    
    UILabel *editLabel = [[UILabel alloc] initWithFrame:CGRectMake(72, 115, 174, 25)];
    editLabel.textColor = [UIColor whiteColor];
    editLabel.text = @"Tap to delete books";
    editLabel.backgroundColor = [UIColor clearColor];
    editLabel.font = [UIFont fontWithName:@"Noteworthy" size:20];
    [helpView addSubview:editLabel];
    
    UILabel *addLabel = [[UILabel alloc] initWithFrame:CGRectMake(52, 225, 194, 25)];
    addLabel.textColor = [UIColor whiteColor];
    addLabel.text = @"Tap to add a new book";
    addLabel.backgroundColor = [UIColor clearColor];
    addLabel.font = [UIFont fontWithName:@"Noteworthy" size:20];
    [helpView addSubview:addLabel];
}
